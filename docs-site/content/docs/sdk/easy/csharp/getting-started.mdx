...
三节点验收固定使用公共 NuGet `WuKongEasySDK 1.0.0`、npm `easyjssdk 2.0.5` 和 Node `24.3.0` 原生 WebSocket，并分别测试正式 C# 包与候选源码。服务端固定为修复源码 `c3dc526de3bc3f91461f32618ebdee7997984058`，测试工具为 `dc99c0fc91f3cd905de30b6a8535953639db611f`；这份源码验证不能归入已发布的 `v3.0.0-beta.9`。
