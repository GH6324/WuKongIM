...
See [C# cluster recovery](/en/sdk/easy/csharp/getting-started#three-node-clusters-and-application-address-replacement) for application endpoint replacement, optional three-node reproduction, and tracked server blockers.
