...
<Cards>
  ...
  <Card title="Rust quickstart" description="Pin Git source and use Tokio for messaging, bounded reconnect and cleanup." href="/en/sdk/easy/rust/getting-started" />
  ...
  <Card title="Python quickstart" description="Pinned source and asyncio for online messaging, heartbeat, reconnect, and cleanup." href="/en/sdk/easy/python/getting-started" />
</Cards>
