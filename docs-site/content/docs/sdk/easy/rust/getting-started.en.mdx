...
To see messages first, follow [the official example](/en/sdk/easy/examples#rust) with two clients. The steps below integrate the SDK into your application.
...
Continue with [messaging](/en/guide/integration/messaging) and [production checks](/en/guide/integration/acceptance). For offline recovery, conversations, unread counts, or push, see [SDK selection](/en/sdk). [Versions and validation records](https://github.com/WuKongIM/WuKongIM/blob/main/docs/superpowers/reports/2026-09-08-easysdk-validation-history.md#rust) retain the exact environments and scope of past runs.
