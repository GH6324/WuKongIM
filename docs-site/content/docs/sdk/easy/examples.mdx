...
三节点 WS 验收、应用切换入口与服务器修复源码的边界见 [C# 集群恢复说明](/zh/sdk/easy/csharp/getting-started#三节点集群与应用切换地址)。
