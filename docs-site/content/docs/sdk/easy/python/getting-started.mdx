---
title: Python 快速接入
description: 安装 WuKongEasySDK-Python 固定源码，用 asyncio 完成在线收发、心跳、重连和资源清理。
---
...
本文固定工程版本 `0.1.0`、源码 `c8cf8b0e66b2b684fc30eecd0f2aac8c0e25c04a`。当前通过源码安装，尚未发布到 PyPI；分发名是 `wukong-easy-sdk`，导入名是 `wukong_easy_sdk`。
