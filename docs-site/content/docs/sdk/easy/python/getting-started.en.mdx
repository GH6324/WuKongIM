...
description: Install pinned WuKongEasySDK-Python source and use asyncio for online messaging, heartbeat, reconnect, and cleanup.
---
...
This tutorial pins project version `0.1.0` at source `c8cf8b0e66b2b684fc30eecd0f2aac8c0e25c04a`. Install from source; there is no PyPI release yet. The distribution name is `wukong-easy-sdk`; the import name is `wukong_easy_sdk`.

```sh
git clone https://github.com/WuKongIM/WuKongEasySDK-Python.git
cd WuKongEasySDK-Python
git checkout c8cf8b0e66b2b684fc30eecd0f2aac8c0e25c04a
python3 -m venv .venv
...
This source completed Python/Python and actual JS `2.0.4` bidirectional messaging, Ping, manual reconnect, invalid-Token rejection, and online cleanup against WuKongIM `0348c0539bbee420a859439695acdac911afa854`, a Token-authenticated 256-hash-slot single-node cluster. Independent WS/WSS tests cover automatic retry, cancellation, queue bounds, and certificate rejection. See the [validation record](https://github.com/WuKongIM/WuKongEasySDK-Python/blob/c8cf8b0e66b2b684fc30eecd0f2aac8c0e25c04a/docs/VALIDATION.md) for the environment and reproduction commands. These are source and local-build receipts, not PyPI package acceptance.
