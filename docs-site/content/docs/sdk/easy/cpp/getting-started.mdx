---
title: C++ 快速接入
description: 使用 WuKongEasySDK-CPP 的固定源码和 CMake，完成 C++17 在线消息、重连与线程生命周期管理。
---
...
<Callout type="info" title="固定源码接入">
  本文固定工程 `0.1.0` 的源码 `8a3218cd5c9465f06df371f040a3641188bd4900`，通过 CMake 编译和安装。当前分发为源码，没有预编译包或 Registry 发布。该源码已连接 WuKongIM `132e46209d98fa0425cc0f88e7a97080cdad044d`，在开启 Token 鉴权的 256 hash slots 单节点集群中完成 C++/C++ 和 C++/JS 双向消息。完整范围见仓库的 [验证记录](https://github.com/WuKongIM/WuKongEasySDK-CPP/blob/8a3218cd5c9465f06df371f040a3641188bd4900/docs/VALIDATION.md)。
</Callout>
