...
- Ordinary and command-style `NoPersist` enter transient online delivery with a message ID and sequence zero. Neither supports durable history or offline recovery; see [Message Flags](/en/api/dictionaries/message-flags).
