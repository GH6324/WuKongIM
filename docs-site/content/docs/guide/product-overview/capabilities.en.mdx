...
- Capacity results should record throughput, P99, error rate, queues, CPU, memory, disk, and network together. See [`wkcli bench`](/en/server/tools/wkbench) for the measurement workflow.
