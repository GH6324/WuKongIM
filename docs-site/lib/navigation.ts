  ...
  return publishedGroup(
    ...
    [
      ...
      publishedPage(
        ...
        'iOS 快速接入',
        'iOS quickstart',
        '精确安装 v1.1.1，完成单聊收发、监听清理和 Alice/Bob 双向消息。',
        'Install exactly v1.1.1 for person messaging, listener cleanup, and Alice/Bob messaging.',
      ),
      publishedPage(
        'android/getting-started',
        'Android 快速接入',
        'Android quickstart',
        '精确安装 v1.0.5，处理单例、单聊收发、清理和 Alice/Bob 双向消息。',
        'Install exactly v1.0.5 for singleton ownership, person messaging, cleanup, and Alice/Bob messaging.',
      ),
      publishedPage(
      ...
      publishedPage(
        ...
        'Web 快速接入',
        'Web quickstart',
        '精确安装 easyjssdk v2.0.5，在浏览器中通过业务后端完成 Alice/Bob 在线消息。',
        'Install exactly easyjssdk v2.0.5 for Alice/Bob browser messaging with credentials from your backend.',
      ),
      publishedPage(
      ...
      publishedPage(
        ...
        'C# 快速接入',
        'C# quickstart',
        '安装 NuGet 1.0.0 正式包接入 .NET 8，完成异步连接、消息收发、重连和释放。',
        'Install NuGet 1.0.0 with .NET 8 for async connections, messaging, reconnect, and cleanup.',
      ),
      publishedPage(
        'cpp/getting-started',
        'C++ 快速接入',
      ...
      publishedPage(
        ...
        'Python 快速接入',
        'Python quickstart',
        '安装 PyPI 0.1.0 正式包，用 asyncio 完成在线收发、重连和异步资源清理。',
        'Install PyPI 0.1.0 and use asyncio for online messaging, reconnect, and async cleanup.',
      ),
    ],
  );
}
