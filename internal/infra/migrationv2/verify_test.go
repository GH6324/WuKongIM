...
func TestIndependentVerificationDetectsAnAlteredCredential(t *testing.T) {
	...
	plan := migration.Plan{Version: 1, SourceCommit: migrationv2.SourceCommit, Sources: []migration.NodeOptions{{NodeID: 1, Options: migration.Options{DataDir: unpackNamedFixture(t, "original-v2-server.tar.gz"), ShardCount: 2}}}, Target: migration.TargetPlan{ClusterID: "verify-fixture", CreatedAt: time.Unix(1788670602, 0).UTC(), SlotCount: 4, HashSlotCount: 256, Replicas: 1, ChannelReplicas: 1, Nodes: []migration.TargetNode{{NodeID: 101, Addr: "127.0.0.1:57882", DataDir: filepath.Join(t.TempDir(), "node")}}}}
