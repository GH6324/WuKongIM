...
var schemaFields = []fieldSpec{
	...
	{TOMLPath: "cluster.channel_rpc_batch_max_items", EnvKey: "WK_CLUSTER_CHANNEL_RPC_BATCH_MAX_ITEMS", Kind: kindInt, Group: "cluster", Label: "Channel RPC batch max items"},
