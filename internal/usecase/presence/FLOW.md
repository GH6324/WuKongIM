...
3. Authority recovery coalesces exact-target UID pages through fixed admission
   lanes, queries current owner projections, and installs only complete fenced
   evidence; failed owner reads remain retryable.
