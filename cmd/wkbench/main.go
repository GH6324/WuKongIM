...
func printWukongIMAttribution(w io.Writer, report benchmetrics.WukongIMAttribution) {
	...
	fmt.Fprintf(w, "channel_pull_batch_items_p50: %.3f\n", report.ChannelRuntimePullBatchItemsP50)
	fmt.Fprintf(w, "channel_pull_batch_items_p99: %.3f\n", report.ChannelRuntimePullBatchItemsP99)
	fmt.Fprintf(w, "channel_pull_batch_records_p50: %.3f\n", report.ChannelRuntimePullBatchRecordsP50)
	fmt.Fprintf(w, "channel_pull_batch_records_p99: %.3f\n", report.ChannelRuntimePullBatchRecordsP99)
	fmt.Fprintf(w, "channel_pull_batch_payload_bytes_p50: %.3f\n", report.ChannelRuntimePullBatchPayloadBytesP50)
	fmt.Fprintf(w, "channel_pull_batch_payload_bytes_p99: %.3f\n", report.ChannelRuntimePullBatchPayloadBytesP99)
	fmt.Fprintf(w, "channel_pull_batch_submit_p99_seconds: %.6f\n", report.ChannelRuntimePullBatchSubmitP99Seconds)
	fmt.Fprintf(w, "channel_pull_batch_await_p99_seconds: %.6f\n", report.ChannelRuntimePullBatchAwaitP99Seconds)
	fmt.Fprintf(w, "channel_pull_batch_max_sequential_await_p99_seconds: %.6f\n", report.ChannelRuntimePullBatchMaxSequentialAwaitP99Seconds)
	fmt.Fprintf(w, "channel_pull_batch_total_p99_seconds: %.6f\n", report.ChannelRuntimePullBatchTotalP99Seconds)
	fmt.Fprintf(w, "channel_worker_rpc_queue_wait_p99_seconds: %.6f\n", report.ChannelRuntimeRPCWorkerQueueWaitP99Seconds)
	fmt.Fprintf(w, "channel_leader_pull_mailbox_wait_p99_seconds: %.6f\n", report.ChannelRuntimeLeaderPullMailboxWaitP99Seconds)
	fmt.Fprintf(w, "channel_leader_pull_ack_apply_p99_seconds: %.6f\n", report.ChannelRuntimeLeaderPullAckApplyP99Seconds)
	fmt.Fprintf(w, "channel_leader_pull_handler_p99_seconds: %.6f\n", report.ChannelRuntimeLeaderPullHandlerP99Seconds)
	fmt.Fprintf(w, "channel_leader_pull_completed_waiters_p50: %.3f\n", report.ChannelRuntimeLeaderPullCompletedWaitersP50)
	fmt.Fprintf(w, "channel_leader_pull_completed_waiters_p99: %.3f\n", report.ChannelRuntimeLeaderPullCompletedWaitersP99)
