...
```sh
./bin/wkmigrate diagnose --plan /srv/wkmigrate/plan.json --workspace /srv/wkmigrate/diagnostic-workspace > /srv/wkmigrate/diagnostic.json
```
...
```sh
./bin/wkmigrate authority --plan /srv/wkmigrate/plan.json --workspace /srv/wkmigrate/authority-workspace > /srv/wkmigrate/authority.json
```
...
```sh
wkmigrate dedupe-plan --plan /absolute/plan.json --workspace /absolute/dedupe-workspace
```
...
```sh
wkmigrate export-map --plan /absolute/plan.json \
