...
func writeLocalSingleNodeCompletionFixtureWithConfig(t *testing.T, configData []byte) (string, string) {
	...
	if err := os.WriteFile(filepath.Join(binDirectory, "wkcli"), wkbenchData, 0o700); err != nil {
		t.Fatal(err)
	}
...
func writeLocalSingleNodeFilesystemIncompleteCompletionFixture(
	...
	if err := os.WriteFile(filepath.Join(root, "bin", "wkcli"), wkbenchData, 0o700); err != nil {
		t.Fatal(err)
	}
