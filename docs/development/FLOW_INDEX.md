...
| [internal/access/api/FLOW.md](../../internal/access/api/FLOW.md) | `package` | Adapts product, benchmark, debug, and compatibility HTTP requests to internal use cases. | 103 | warning |
...
| [internal/access/gateway/FLOW.md](../../internal/access/gateway/FLOW.md) | `package` | Maps gateway sessions and frames to message, presence, and delivery usecases without owning authority or durable-send policy. | 70 | ok |
...
| [internal/access/manager/FLOW.md](../../internal/access/manager/FLOW.md) | `package` | Adapts authenticated Manager HTTP and UI operations to bounded management use cases. | 82 | ok |
| [internal/access/node/FLOW.md](../../internal/access/node/FLOW.md) | `package` | Adapts versioned node RPC frames to local authority, runtime, and management ports. | 96 | ok |
...
| [internal/infra/cluster/FLOW.md](../../internal/infra/cluster/FLOW.md) | `package` | Adapts internal ports to cluster, channel, metadata, node-RPC, and operations runtimes without owning business policy. | 94 | ok |
| [internal/infra/delivery/FLOW.md](../../internal/infra/delivery/FLOW.md) | `package` | Adapts presence lookup and owner-local session writes for canonical online delivery. | 49 | ok |
...
| [internal/runtime/channelappend/FLOW.md](../../internal/runtime/channelappend/FLOW.md) | `package` | Owns routed local Channel append admission, ordered durable writes, item futures, and bounded post-commit delivery handoff. | 94 | ok |
...
| [internal/runtime/delivery/FLOW.md](../../internal/runtime/delivery/FLOW.md) | `package` | Executes canonical online delivery plans with bounded Channel ordering, owner routing, retries, and RECVACK state. | 65 | ok |
...
| [internal/runtime/online/FLOW.md](../../internal/runtime/online/FLOW.md) | `package` | Maintains node-local pending and active connection routes, concrete session handles, and bounded touch batching. | 49 | ok |
...
| [internal/runtime/presence/FLOW.md](../../internal/runtime/presence/FLOW.md) | `package` | Maintains hash-slot-authoritative virtual connection routes with exact fencing, conflict staging, touch, and TTL expiry. | 56 | ok |
...
| [internal/usecase/benchterminal/FLOW.md](../../internal/usecase/benchterminal/FLOW.md) | `package` | Owns one exact benchmark terminal drain, capability grant, and session-seal admission proof. | 68 | ok |
...
| [internal/usecase/chatlifecyclerun/FLOW.md](../../internal/usecase/chatlifecyclerun/FLOW.md) | `package` | Materializes bounded repair, rehearsal, and formal chat-lifecycle run plans from reviewed templates and trusted context. | 60 | ok |
| [internal/usecase/cloudanalysis/FLOW.md](../../internal/usecase/cloudanalysis/FLOW.md) | `package` | Validates exact-run Analysis MCP requests and returns bounded observations from narrow live sources. | 56 | ok |
| [internal/usecase/clouddeploy/FLOW.md](../../internal/usecase/clouddeploy/FLOW.md) | `package` | Seals provider-neutral offline deployment bundles, exact Lease plans, host files, and typed readiness receipts. | 78 | ok |
...
| [internal/usecase/conversation/FLOW.md](../../internal/usecase/conversation/FLOW.md) | `package` | Builds transient conversations from UID membership and Channel state, and owns badge, hide, and activation commands. | 75 | ok |
...
| [internal/usecase/management/FLOW.md](../../internal/usecase/management/FLOW.md) | `package` | Builds entry-independent Manager read models and safety-gated orchestration over narrow cluster, runtime, and diagnostic ports. | 81 | ok |
| [internal/usecase/message/FLOW.md](../../internal/usecase/message/FLOW.md) | `package` | Owns entry-independent message permission policy, send orchestration, committed sync, and message-event projection contracts. | 90 | ok |
...
| [internal/usecase/presence/FLOW.md](../../internal/usecase/presence/FLOW.md) | `package` | Coordinates owner-local connection lifecycle with UID authority registration, actions, touch batching, and route lookup. | 61 | ok |
...
| [pkg/channel/FLOW.md](../../pkg/channel/FLOW.md) | `subtree` | Implements the reusable multi-reactor Channel log runtime, replication, persistence ports, transport, services, and bounded workers. | 104 | warning |
...
| [pkg/cluster/FLOW.md](../../pkg/cluster/FLOW.md) | `subtree` | Composes Controller state, Slot Multi-Raft metadata, typed node RPC, routing, and replicated Channel runtimes behind Node. | 105 | warning |
| [pkg/controller/FLOW.md](../../pkg/controller/FLOW.md) | `subtree` | Implements the canonical Controller Raft runtime, durable cluster state, mirror synchronization, planning, and fenced task transitions. | 84 | ok |
| [pkg/db/FLOW.md](../../pkg/db/FLOW.md) | `subtree` | Guides node-local storage ownership, root lifecycle, message and metadata domains, snapshots, metrics, and engine isolation. | 57 | ok |
| [pkg/db/message/FLOW.md](../../pkg/db/message/FLOW.md) | `package` | Stores Channel message logs, indexes, checkpoints, retention state, snapshots, and compatibility leases on the shared DB engine. | 101 | warning |
| [pkg/db/meta/FLOW.md](../../pkg/db/meta/FLOW.md) | `package` | Owns Hash-Slot-scoped metadata tables, deterministic batches, membership directories, snapshots, restore, and cache invalidation. | 72 | ok |
